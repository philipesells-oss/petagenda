...
export default function LandingPagePreview() {
  return (
    <div className="min-h-screen bg-white text-gray-900 dark:bg-gray-950 dark:text-gray-100">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-teal-50 px-4 py-20 text-center dark:from-emerald-950/30 dark:via-gray-950 dark:to-teal-950/20 md:py-28">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mx-auto mb-8 max-w-xl text-lg text-gray-600 dark:text-gray-400">
            Agenda inteligente, clientes organizados e caixa no controle. Tudo num só lugar, simples de usar no balcão ou no celular.
          </p>
          ...
          <p className="mt-3 text-xs text-gray-500 dark:text-gray-500">Cancele quando quiser · Sem taxa de adesão</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              <div key={f.title} className="flex gap-4 rounded-2xl border border-gray-100 p-5 dark:border-gray-800">
      ...
      {/* ── NOVA SEÇÃO: Plataforma por dentro ── */}
      <PlatformShowcase />

      {/* ── Depoimentos */}
      <section className="bg-emerald-50 px-4 py-16 dark:bg-emerald-950/20">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-10 text-center text-2xl font-bold md:text-3xl">Donos de pet shop que já saíram do caderninho</h2>
          <div className="grid gap-6 md:grid-cols-2">
            {[
          ...
          <div className="flex items-start gap-4 rounded-2xl border-2 border-emerald-200 bg-emerald-50 px-6 py-6 dark:border-emerald-800 dark:bg-emerald-950/40">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                Se em 7 dias você não ficar satisfeito, devolvemos 100% do valor pago. Sem perguntas, sem burocracia. É o seu direito garantido pelo{' '}
      ...
      <section className="bg-emerald-600 px-4 py-20 text-center dark:bg-emerald-800">
        <div className="mx-auto max-w-2xl">
          <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">Seu próximo banho pode já sair organizado.</h2>
          <p className="mb-8 text-emerald-100">Menos de R$1 por dia pra trocar o caderninho por um pet shop profissional. Ative agora e comece a usar hoje mesmo.</p>
          <CheckoutButton className="bg-white text-emerald-700 hover:bg-emerald-50 px-8 shadow-lg" />
          <p className="mt-4 text-sm text-emerald-200">🛡️ Garantia de 7 dias — não gostou, devolvemos tudo. Sem perguntas.</p>
        </div>
      </section>
